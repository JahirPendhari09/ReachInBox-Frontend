...
const ReplySection:React.FC<replyProps> = ({currColor}) => {
  ...
  return (
    <div  className='w-[800px] border border-gray-700 flex justify-between flex-col '>
        <div className=' relative w-[800px] flex justify-between flex-col ' >
            ...
            <div className='py-3 pl-4 '>
                <h2 className='text-[10px] mb-3'>Today</h2>
                <SingleMail currColor={currColor}/>
                <h2 className='mt-2 text-[10px] mb-3'>View all 4 replies</h2> 
                {/* <SingleMail currColor={currColor}/> */}
            </div> 
            {
                showReply &&  <div className={`absolute mt-[134px] w-[768px] ml-4 rounded-2xl  z-10  overflow-hidden  h-[450px] ${currColor ? 'bg-[#141517]': 'bg-white'}  border border-gray-700`}>
                    <SendReply currColor ={currColor} handleCancel ={()=> setShowReply(!showReply)}/>
